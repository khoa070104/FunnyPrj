...
// INSERT INTO tblUsers(username,email,fullName,password,role,status,code)
        HttpSession session = request.getSession();
        if (userInsert==null) {
            System.out.println("1");
            // If email does not exist, save the user
            userInsert = new User();
            ...
            i.register(userInsert.getEmail(),userInsert.getPassword(),userInsert.getUsername(),userInsert.getFullName(),userInsert.getCode(),userInsert.getAvatar());
        } else {
